"""
Logistic Regression, Adapted for our usage

    Changes:
        * added max_evals parameter
"""
...
def _logistic_regression_path(
    ...
    max_fun: int, default=100
        Maximum number of function evaluations for the solver.
...
class LogisticRegression(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    max_fun : int, default=100
        Maximum number of function evaluations taken for the solvers to converge.
        Only supported for some solvers.
